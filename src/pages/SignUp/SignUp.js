        ...
        <View style={{ flex: 1, backgroundColor: color.white, }}>
            <ImageBackground style={{ height: '100%', width: '100%', }} source={require('../../Images/ImageBack.png')}>
                ...
                <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <Text style={{ fontSize: 20, color: color.buttonYellow, fontWeight: '400' }}>Create your Account</Text>
                    <View style={{ marginVertical: 30, width: '80%', }}>
                        ...
                        <View style={{
                            ...
                            <TouchableOpacity
                                ...
                                <Text style={{ color: color.white, fontSize: 15, fontWeight: '500', textAlign: 'center', }}>Create Account
                                </Text>
                            </TouchableOpacity>
                        </View>
